...
@Suppress("unused")
fun <T> forAll(gen: GenV1<T>, test: TestByBool<T>) = forAll(TestConfig(), gen, test)
fun <T> forAll(config: TestConfig, gen: GenV1<T>, test: TestByBool<T>) = test(config, gen, test as Test<T>)

@Suppress("unused")
fun <T> checkAll(gen: GenV1<T>, test: TestByThrowing<T>) = checkAll(TestConfig(), gen, test)
fun <T> checkAll(config: TestConfig, gen: GenV1<T>, test: TestByThrowing<T>) = test(config, gen, test as Test<T>)
