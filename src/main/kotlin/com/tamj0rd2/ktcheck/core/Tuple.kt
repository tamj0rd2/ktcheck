...
@ConsistentCopyVisibility
data class Tuple5<A, B, C, D, E> internal constructor(val val1: A, val val2: B, val val3: C, val val4: D, val val5: E) :
    Tuple {
...
@ConsistentCopyVisibility
data class Tuple6<A, B, C, D, E, F> internal constructor(
    val val1: A,
    val val2: B,
    val val3: C,
    val val4: D,
...
internal constructor(val val1: A, val val2: B, val val3: C, val val4: D, val val5: E, val val6: F, val val7: G) :
    Tuple {
